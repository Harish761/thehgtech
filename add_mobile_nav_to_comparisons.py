#!/usr/bin/env python3
"""
Add mobile navigation to all comparison pages
"""
...
def add_mobile_nav_to_file(filepath):
    """Add mobile navigation to a comparison file"""
...
def main():
    comparisons_dir = '/Volumes/Data-Personal/Webpage/thehgtech/comparisons'
    ...
    print(f"\nUpdated {updated} comparison files")
